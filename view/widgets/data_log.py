...
class DataLogWidget(QWidget):
    ...
    def init_ui(self) -> None:
        ...
        toolbar_row1_layout.addWidget(self.data_log_title)
        toolbar_row1_layout.addStretch()
        toolbar_row1_layout.addWidget(self.data_log_tx_broadcast_allowed_chk)
        toolbar_row1_layout.addWidget(self.data_log_filter_chk)
        toolbar_row1_layout.addWidget(self.data_log_newline_combo)
        toolbar_row1_layout.addWidget(self.data_log_hex_chk)
        toolbar_row1_layout.addWidget(self.data_log_timestamp_chk)
        ...
        toolbar_row2_layout.addWidget(self.data_log_clear_log_btn)
        toolbar_row2_layout.addWidget(self.data_log_toggle_logging_btn)
        ...
        layout.addLayout(toolbar_row1_layout)
        layout.addLayout(toolbar_row2_layout)
    ...
    def retranslate_ui(self) -> None:
        ...
        self.data_log_tx_broadcast_allowed_chk.setText(language_manager.get_text("data_log_chk_tx_broadcast_allowed"))
        self.data_log_tx_broadcast_allowed_chk.setToolTip(language_manager.get_text("data_log_chk_tx_broadcast_allowed_tooltip"))
    ...
    @pyqtSlot(int)
    def on_data_log_tx_broadcast_allowed_changed(self, state: int) -> None:
        """
        ...
        Args:
            state (int): 체크박스 상태.
        """
        self.tx_broadcast_allowed_enabled = (state == Qt.Checked)
        self.tx_broadcast_allowed_changed.emit(self.tx_broadcast_allowed_enabled)
    ...
    def broadcast_enabled_enabled(self) -> bool:
        ...
        """
        return self.tx_broadcast_allowed_enabled
    ...
    def get_state(self) -> dict:
        ...
        """
        return {
            "tx_broadcast_allowed_enabled": self.tx_broadcast_allowed_enabled,
    ...
    def apply_state(self, state: dict) -> None:
        ...
        self.data_log_tx_broadcast_allowed_chk.setChecked(state.get("tx_broadcast_allowed_enabled", False))
