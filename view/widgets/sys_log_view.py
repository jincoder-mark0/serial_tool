...
class SysLogViewWidget(QWidget):
    """
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        # ---------------------------------------------------------
        # UI Components
        self.sys_log_view_title = None
        self.sys_log_view_list = None
    ...
    def init_ui(self) -> None:
        ...
        # 1. 툴바 영역 (타이틀 + 도구들)
        # 타이틀 섹션
        self.sys_log_view_title = QLabel(lang_manager.get_text("sys_log_view_title"))
        self.sys_log_view_title.setProperty("class", "section-title")  # 섹션 타이틀 스타일 적용

        # 도구 섹션 (검색, 옵션, 액션)
        # Search Bar
        self.sys_log_search_input = QLineEdit()
        self.sys_log_search_input.setPlaceholderText(lang_manager.get_text("sys_log_view_input_search_placeholder"))
        self.sys_log_search_input.setToolTip(lang_manager.get_text("sys_log_view_input_search_tooltip"))
        ...
        self.sys_log_search_prev_btn.setToolTip(lang_manager.get_text("sys_log_view_btn_search_prev_tooltip"))
        ...
        self.sys_log_search_next_btn.setToolTip(lang_manager.get_text("sys_log_view_btn_search_next_tooltip"))
        ...
        self.sys_log_clear_log_btn = QPushButton(lang_manager.get_text("sys_log_view_btn_clear"))
        self.sys_log_clear_log_btn.setToolTip(lang_manager.get_text("sys_log_view_btn_clear_tooltip"))
        self.sys_log_clear_log_btn.clicked.connect(self.on_clear_sys_log_view_clicked)

        self.sys_log_toggle_logging_btn = QPushButton(lang_manager.get_text("sys_log_view_btn_toggle_logging"))
        self.sys_log_toggle_logging_btn.setToolTip(lang_manager.get_text("sys_log_view_btn_toggle_logging_tooltip"))
        ...
        # Options
        self.sys_log_filter_chk = QCheckBox(lang_manager.get_text("sys_log_view_chk_filter"))
        self.sys_log_filter_chk.setToolTip(lang_manager.get_text("sys_log_view_chk_filter_tooltip"))
        self.sys_log_filter_chk.stateChanged.connect(self.on_sys_log_filter_changed)
        # 2. 로그 뷰 영역
        # self.sys_log_view_list = QTextEdit()
        self.sys_log_view_list = QSmartListView()
        self.sys_log_view_list.set_max_lines(DEFAULT_LOG_MAX_LINES)
        self.sys_log_view_list.setReadOnly(True)
        self.sys_log_view_list.setPlaceholderText(lang_manager.get_text("sys_log_view_list_log_placeholder"))
        self.sys_log_view_list.setToolTip(lang_manager.get_text("sys_log_view_list_log_tooltip"))
        self.sys_log_view_list.setProperty("class", "fixed-font")  # 고정폭 폰트 적용

        # Layout 배치
        toolbar_layout = QHBoxLayout()
        toolbar_layout.addWidget(self.sys_log_view_title)
        ...
        layout.addWidget(self.sys_log_view_list)
    ...
    def retranslate_ui(self) -> None:
        ...
        # Labels & Tooltips
        self.sys_log_view_title.setText(lang_manager.get_text("sys_log_view_title"))
        self.sys_log_view_list.setToolTip(lang_manager.get_text("sys_log_view_list_log_tooltip"))
        self.sys_log_view_list.setPlaceholderText(lang_manager.get_text("sys_log_view_list_log_placeholder"))
        ...
        # Checkboxes
        self.sys_log_filter_chk.setText(lang_manager.get_text("sys_log_view_chk_filter"))
        self.sys_log_filter_chk.setToolTip(lang_manager.get_text("sys_log_view_chk_filter_tooltip"))

        # Buttons
        self.sys_log_clear_log_btn.setText(lang_manager.get_text("sys_log_view_btn_clear"))
        self.sys_log_clear_log_btn.setToolTip(lang_manager.get_text("sys_log_view_btn_clear_tooltip"))

        # 로깅 버튼 텍스트는 상태에 따라 달라짐 (토글 시)
        if not self.sys_log_toggle_logging_btn.isChecked():
            self.sys_log_toggle_logging_btn.setText(lang_manager.get_text("sys_log_view_btn_toggle_logging"))
        self.sys_log_toggle_logging_btn.setToolTip(lang_manager.get_text("sys_log_view_btn_toggle_logging_tooltip"))
    ...
    def log(self, message: str, level: str = "INFO") -> None:
        ...
        # 4. 뷰에 추가
        self.sys_log_view_list.append(full_text)

    def clear(self) -> None:
        """로그를 초기화합니다."""
        self.sys_log_view_list.clear()
    ...
    def on_sys_log_search_next_clicked(self) -> None:
        ...
        if text:
            ...
            self.sys_log_view_list.set_search_pattern(text)
            self.sys_log_view_list.find_next(text)
    ...
    def on_sys_log_search_prev_clicked(self) -> None:
        ...
        text = self.sys_log_search_input.text()
        if text:
            self.sys_log_view_list.find_prev(text)
    ...
    @pyqtSlot()
    def on_clear_sys_log_view_clicked(self) -> None:
    ...
    def on_sys_log_logging_toggled(self, checked: bool) -> None:
        ...
        if checked:
            # 파일 저장 대화상자
            title = lang_manager.get_text("sys_log_view_btn_toggle_logging")
            if self.tab_name:
    ...
    def on_sys_log_filter_changed(self, state: int) -> None:
        ...
        self.sys_log_view_list.set_filter_mode(self.filter_enabled)
