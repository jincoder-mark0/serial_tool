...
class FileProgressWidget(QWidget):
    ...
    def init_ui(self) -> None:
        ...
        # 파일명 및 상태 레이블
        self.status_label = QLabel(language_manager.get_text("status_ready"))
    ...
    def retranslate_ui(self) -> None:
        ...
        # 다만, Ready 상태라면 변경 가능
        if self.status_label.text() == language_manager.get_text("status_ready", "en") or \
           self.status_label.text() == language_manager.get_text("status_ready", "ko"):
            self.status_label.setText(language_manager.get_text("status_ready"))
