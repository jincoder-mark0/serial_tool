...
class MainToolBar(QToolBar):
    ...
    def init_ui(self):
        ...
        # Open
        self.open_action = QAction(lang_manager.get_text("toolbar_btn_open"), self)
        self.open_action.triggered.connect(self.open_requested.emit)
        self.addAction(self.open_action)

        # Close
        self.close_action = QAction(lang_manager.get_text("toolbar_btn_close"), self)
        self.close_action.triggered.connect(self.close_requested.emit)
        self.addAction(self.close_action)

        # Clear
        self.clear_action = QAction(lang_manager.get_text("toolbar_btn_clear"), self)
