...
- Status: DONE (2026-08-22 — 하위 모델 수행, 상위 리뷰 승인. **1471×786 → ko 1093×780 /
  en 1097×780** — 폭 목표(≤1280) 초과 달성: DataLog 툴바 2행화(검색창 120px 확보로 35px
  압착도 해소) + MacroControl 3행화 + SystemLog 최소 높이 60. 위젯 생성·시그널·retranslate
  불변, pytest 122·캡처 16장 검증. 높이 780은 목표 730 대비 +50 — 설계 범위 내 조치 완료
  후 규칙대로 중단·보고. 잔여 높이와 이번 축소로 새로 드러난 매크로 테이블 헤더 잘림은
  [S-032](S-032-min-height-and-macro-header.md)로 분리)
